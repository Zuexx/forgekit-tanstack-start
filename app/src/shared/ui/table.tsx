...
const Table = ({ className, style, ...props }: TableProps) => (
  <div data-slot="table-container" {...stylex.props(styles.container)}>
    <table
      data-slot="table"
      {...stylex.props(styles.table, customClassName(className), style)}
      {...props}
    />
  </div>
)
...
const TableBody = ({ className, style, ...props }: TableBodyProps) => (
  <tbody
    ...
    {...stylex.props(styles.body, customClassName(className), style)}
    {...props}
  />
)
...
const TableRow = ({ className, style, ...props }: TableRowProps) => (
  <tr
    data-slot="table-row"
    {...stylex.props(styles.row, customClassName(className), style)}
    {...props}
  />
)
...
const TableHead = ({ className, style, ...props }: TableHeadProps) => (
  <th
    ...
    {...stylex.props(styles.head, customClassName(className), style)}
    {...props}
  />
)
...
const TableCell = ({ className, style, ...props }: TableCellProps) => (
  <td
    ...
    {...stylex.props(styles.cell, customClassName(className), style)}
    {...props}
  />
)
...
const TableCaption = ({ className, style, ...props }: TableCaptionProps) => (
  <caption
    ...
    {...stylex.props(styles.caption, customClassName(className), style)}
    {...props}
  />
)
